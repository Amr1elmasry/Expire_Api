...
namespace Expire_Api.Services
{
    public class SellerService : ISellerService
    {
        ...
        public SellerService(ApplicationDbContext context, UserManager<Seller> userManager, RoleManager<IdentityRole> roleManager, SignInManager<Seller> signInManager)
        {
            _context = context;
